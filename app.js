...
const alphabetData = [
    ...
    { letter: 'E', word: 'Elephant', image: ASSETS.alphabet + "b.png", sound: ASSETS.alphabet + "b.mp3" },
    { letter: 'F', word: 'Fish', image: ASSETS.alphabet + "c.png", sound: ASSETS.alphabet + "c.mp3" },
    { letter: 'G', word: 'Goat', image: ASSETS.alphabet + "a.png", sound: ASSETS.alphabet + "a.mp3" },
    { letter: 'H', word: 'Horse', image: ASSETS.alphabet + "b.png", sound: ASSETS.alphabet + "b.mp3" },
    { letter: 'I', word: 'Ice Cream', image: ASSETS.alphabet + "c.png", sound: ASSETS.alphabet + "c.mp3" },
    { letter: 'J', word: 'Juice', image: ASSETS.alphabet + "a.png", sound: ASSETS.alphabet + "a.mp3" },
    { letter: 'K', word: 'Kite', image: ASSETS.alphabet + "b.png", sound: ASSETS.alphabet + "b.mp3" },
    { letter: 'L', word: 'Lion', image: ASSETS.alphabet + "c.png", sound: ASSETS.alphabet + "c.mp3" },
    { letter: 'M', word: 'Monkey', image: ASSETS.alphabet + "a.png", sound: ASSETS.alphabet + "a.mp3" },
    { letter: 'N', word: 'Nest', image: ASSETS.alphabet + "b.png", sound: ASSETS.alphabet + "b.mp3" },
    { letter: 'O', word: 'Orange', image: ASSETS.alphabet + "c.png", sound: ASSETS.alphabet + "c.mp3" },
    { letter: 'P', word: 'Parrot', image: ASSETS.alphabet + "a.png", sound: ASSETS.alphabet + "a.mp3" },
    { letter: 'Q', word: 'Queen', image: ASSETS.alphabet + "b.png", sound: ASSETS.alphabet + "b.mp3" },
    { letter: 'R', word: 'Rabbit', image: ASSETS.alphabet + "c.png", sound: ASSETS.alphabet + "c.mp3" },
    { letter: 'S', word: 'Sun', image: ASSETS.alphabet + "a.png", sound: ASSETS.alphabet + "a.mp3" },
    { letter: 'T', word: 'Train', image: ASSETS.alphabet + "b.png", sound: ASSETS.alphabet + "b.mp3" },
    { letter: 'U', word: 'Umbrella', image: ASSETS.alphabet + "c.png", sound: ASSETS.alphabet + "c.mp3" },
    { letter: 'V', word: 'Van', image: ASSETS.alphabet + "a.png", sound: ASSETS.alphabet + "a.mp3" },
    { letter: 'W', word: 'Whale', image: ASSETS.alphabet + "b.png", sound: ASSETS.alphabet + "b.mp3" },
    { letter: 'X', word: 'Xylophone', image: ASSETS.alphabet + "c.png", sound: ASSETS.alphabet + "c.mp3" },
    { letter: 'Y', word: 'Yo-Yo', image: ASSETS.alphabet + "a.png", sound: ASSETS.alphabet + "a.mp3" },
    { letter: 'Z', word: 'Zebra', image: ASSETS.alphabet + "b.png", sound: ASSETS.alphabet + "b.mp3" },
];
